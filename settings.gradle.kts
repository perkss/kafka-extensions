...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            version("test-containers", "1.16.2")
            ...
            alias("test-containers-core").to("org.testcontainers", "testcontainers").versionRef("test-containers")
            alias("test-containers-kafka").to("org.testcontainers", "kafka").versionRef("test-containers")
